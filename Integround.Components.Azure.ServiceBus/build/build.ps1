# Set up variables:
$Version = "1.0.1"
$ProductName = "Integround.Components.Azure.ServiceBus"
...
$files = "..\Integround.Components.Azure.ServiceBus\Properties\AssemblyInfo.cs"
...
# Set nuget version:
$nugetConfiguration = ".\Integround.Components.Azure.ServiceBus.nuspec"

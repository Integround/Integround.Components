# Set up variables:
$Version = "1.0.0"
$ProductName = "Integround.Components.Files.Ftp"
...
$files = "..\Integround.Components.Files.FtpClient\Properties\AssemblyInfo.cs", "..\Integround.Components.Files.SftpClient\Properties\AssemblyInfo.cs"
...
# Set nuget version:
$nugetConfiguration = ".\Integround.Components.Files.Ftp.nuspec"

# Set up variables:
$Version = "1.1.0"
$ProductName = "Integround.Components.Azure.Storage"
...
$files = "..\Integround.Components.Azure.Storage\Properties\AssemblyInfo.cs"
...
# Set nuget version:
$nugetConfiguration = ".\Integround.Components.Azure.Storage.nuspec"

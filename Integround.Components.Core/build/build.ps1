...
$files = "..\Integround.Components.Core\Properties\AssemblyInfo.cs", "..\Integround.Components.Core.FlatFile\Properties\AssemblyInfo.cs", "..\Integround.Components.Core.Xslt\Properties\AssemblyInfo.cs"
